    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          <Scroll ref="playList" v-if="currentIndex === 0" :data="playHistory" class="list-scroll">
            <div class="list-inner">
              <SongList :songs="playHistory" @selectItem="selectSong"></SongList>
            </div>
          </Scroll>
  ...
  methods: {
    ...
    selectSong(song, index) {
      if (index !== 0) {
        ...
        // 从缓存里出来的对象，仅仅是具有song的属性，并不是一个song实例，需要转化
